        ...
        <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-2">
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-2 text-base text-gray-500 text-center hover:underline"
            >
            ...
            <div className="text-center">
              <ConsultButton
                style={
                  "btn btn-primary inline-flex px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white mt-6"
                }
              />
            </div>
          </div>
