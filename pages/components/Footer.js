  ...
  return (
    <footer className="bg-primary body-font">
      ...
      <div className="block p-5">
        <p className="text-lg text-center text-white">Created by <a className="hover:underline" href="https://asarelcastellanos.com" target="_blank" rel="noreferrer">Asarel</a>. Special thanks to <a className="hover:underline" href="https://chrisglz.com/" target="_blank" rel="noreferrer">Gio</a></p>
      </div>
    </footer>
  );
};
